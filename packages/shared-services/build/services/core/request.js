...
export const getHeaders = (config, options, formData) => __awaiter(void 0, void 0, void 0, function* () {
...
export const sendRequest = (config, options, url, body, formData, headers, onCancel, axiosClient) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return new CancelablePromise((resolve, reject, onCancel) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            if (!onCancel.isCancelled) {
                const response = yield sendRequest(config, options, url, body, formData, headers, onCancel, axiosClient);
