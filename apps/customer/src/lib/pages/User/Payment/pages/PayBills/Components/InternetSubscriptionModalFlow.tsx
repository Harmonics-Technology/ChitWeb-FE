...
//     <Box>
//       <Box mb="30px">
//         <Heading mb="16px" color="text.200" fontWeight={700} fontSize={26}>
//           Airtime and Data Summary
//         </Heading>
//       </Box>
//       <Box>
//         <Stack spacing="25px">
    ...
    <Box>
      ...
      <Stack spacing="15px">
        ...
        <Box>
          ...
          <Select>
            <option value="prepaid">Airtime</option>
            <option value="postpaid">Data</option>
          </Select>
        </Box>
        <Box>
          <FormLabel color="text.200" fontSize={14}>
...
const InternetSubscriptionModalFlow = () => {
...
export default InternetSubscriptionModalFlow;
