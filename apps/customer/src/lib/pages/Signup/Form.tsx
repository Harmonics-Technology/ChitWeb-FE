...
import { Box, Text, Heading, FormControl, FormLabel, Stack, Flex, InputGroup, InputLeftAddon, Input, InputRightElement, Button } from '@chakra-ui/react'
...
const Form = () => {
  ...
  return (
      <Box w='100%'>
          <Box w='80%' mx='auto'>
              <Box mb='24px'>
                  <Heading color='black.100' fontSize={40} fontWeight={600} mb='16px'>Create Account</Heading>
                  <Text>To begin your journey with us, kindly provide us with your information</Text>
              </Box>
              <Box mb='40px'>
                  <FormControl>
                      <Stack spacing="24px">
